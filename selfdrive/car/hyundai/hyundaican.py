...
def create_acc_commands(packer, enabled, accel, accel_value, idx, lead_visible, set_speed, stopping, gas_pressed):
  commands = []
  ...
  scc12_values = {
    ...
    "aReqRaw": accel,
    "aReqValue": accel_value,  # stock ramps up and down respecting jerk limit until it reaches aReqRaw
